...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "a2d8169191947763")]
...
#pragma warning restore 0109
	...
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "OurStories";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public OurStories(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<OurStories, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
...
#pragma warning restore 0109
	...
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "PropertyResults";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public PropertyResults(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<PropertyResults, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
